...
class Orders
{
    ...
    {
        $query = DB::connection()->prepare('SELECT * from Orders ORDER BY order_time ASC');
    ...
    public function update()
    {
        ...
        $query->execute(array('actual_delivery_time' => $this->actual_delivery_time,
            'status' => $this->status,
            'id' => $this->id, ));
    }
}

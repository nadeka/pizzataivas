...
class Ingredient {
    ...
    public static function findByCategory($category) {
        $cheeses = array(); $toppings = array(); $bases = array();
        $sauces = array();
        
        if ( $category != "Juoma" ) {
            $toppings = Ingredient::findByType('Täyte');
            $sauces = Ingredient::findByType('Kastike');
            
            if ( $category == "Pizza" ) {
                $cheeses = Ingredient::findByType('Juusto');
                $bases = Ingredient::findByType('Pizzapohja');
            } else if ( $category == 'Kebab' ) {
                $cheeses = null;
                $bases = Ingredient::findByType('Kebab-lisuke');
            } else {
                $cheeses = null;
                $bases = null;                
            }

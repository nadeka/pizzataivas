...
class UsersController extends BaseController {
    ...
    public static function login() {
        ...
        if ( $user ) {
            ...
            View::make("user/login.html", array('message' => 
    ...
    public static function add() {
        ...
        if ( count(Users::findByUsername($attributes['username'])) > 0 ) {
            View::make('user/add.html', array('message' => 
                'Käyttäjätunnus on varattu!', 'attributes' => $attributes));            
        }
        ...
        if ( $validator->validate() ) {          
            ...
            View::make('user/add.html', array('errors' => 
                $validator->errors(), 'attributes' => $attributes));
        }
    }       
